...
export const CANDLE_CATEGORIES: Category[] = [
  {
    ...
    description:
      'Custom fragrance blends, custom name labels, and photo-embedded candles designed to capture your personal story.',
    ...
    subCategories: [
      {
        ...
        description:
          'Create a scent that is uniquely yours, blending your favorite aromas into a signature fragrance.',
        examples: ['Lavender & Vanilla', 'Citrus & Sage', 'Rose & Sandalwood'],
        visual: {
          vessel: 'jar',
          waxFrom: '#efe7dc',
          waxTo: '#cbbca6',
          labelNote: 'Signature Blend',
        },
      },
      {
        ...
        description:
          'Add a personal touch with custom labels featuring names, dates, or special messages.',
        examples: [
          'John & Jane - 10.10.2023',
          'Happy Birthday, Alex!',
          'Our Wedding Day - 05.05.2024',
        ],
        visual: {
          vessel: 'jar',
          waxFrom: '#f5f0e8',
          waxTo: '#d8ccb8',
          labelNote: 'Your Name Here',
        },
      },
      {
        ...
        description:
          'Incorporate cherished photos into your candle design, creating a keepsake that illuminates memories.',
        examples: ['Family Portrait Candle', 'Pet Photo Candle', 'Vacation Memory Candle'],
        visual: {
          vessel: 'pillar',
          waxFrom: '#f7f3ec',
          waxTo: '#cfc3b0',
          labelNote: 'Memory Keepsake',
        },
      },
    ],
  },
  {
    ...
    description:
      'Hand-poured soy wax candles in minimalist frosted glass jars, rustic wooden wicks, and portable tins.',
    ...
    subCategories: [
      ...
      },
      {
        ...
        description:
          'Experience the soothing crackle of wooden wicks in our rustic candle collection.',
        examples: ['Wooden wick candles', 'Rustic jar candles', 'Hand-poured wooden wick blends'],
        visual: {
          vessel: 'jar',
          waxFrom: '#e8dcc8',
          waxTo: '#b39b78',
          labelNote: 'Crackling Wood Wick',
        },
      },
    ],
  },
  {
    ...
    description:
      'Playful yet sophisticated designs mimicking gourmet desserts, smoothies, and cocktail delights.',
    ...
    subCategories: [
      ...
      },
      {
        ...
        description:
          'Whimsical candle designs that bring a touch of fun and creativity to your space.',
        examples: ['Animal-shaped candles', 'Abstract art candles', 'Miniature scene candles'],
        visual: {
          vessel: 'sculpture',
          waxFrom: '#f3ece4',
          waxTo: '#c8b6a4',
          labelNote: 'Hand Sculpted',
        },
      },
      {
  ...
  },
  {
    ...
    description:
      'Intricately handcrafted brass urlis, floral-embedded wax diyas, and exclusive seasonal releases.',
  ...
  },
  {
    ...
    description:
      'Granulated sand wax interactive setups and real embedded dried flowers for a natural aesthetic.',
    ...
    subCategories: [
      ...
      },
      {
        ...
        description:
          'Unique and creative wax designs that push the boundaries of traditional candle making.',
        examples: ['Geometric wax candles', 'Layered color wax designs', 'Sculptural wax art'],
        visual: {
          vessel: 'sculpture',
          waxFrom: '#eceef0',
          waxTo: '#b0b6bd',
          labelNote: 'Geometric Form',
        },
      },
    ],
  },
  {
    ...
    description:
      'We provide a curated selection of high-quality raw materials for candle making, including soy wax, fragrance oils, wicks, moulds and containers.',
